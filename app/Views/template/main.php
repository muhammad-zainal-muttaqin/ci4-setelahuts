...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default" data-assets-path="<?php echo base_url(); ?>/public/assets/" data-template="vertical-menu-template-free">
...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="<?php echo base_url(); ?>/public/assets/img/favicon/favicon.ico" />
